...
public class SetSecond implements Function {
  @Override
  ...
  public Value execute(ValueList valueList, ExecutorContext executorContext) throws ExpressionException {
    ...
    if (!t.isSupported(ChronoUnit.SECONDS)) {
      throw new ExpressionException("Second is not supported");
    }

    t = t.with(ChronoField.SECOND_OF_MINUTE, valueOffset.toLong());
